#!/bin/bash
## Job Name
#SBATCH --job-name=20210309_hemat_transdecoder_transcriptomes_v1.6_v1.7
...
#SBATCH --chdir=/gscratch/scrubbed/samwhite/outputs/20210309_hemat_transdecoder_transcriptomes_v1.6_v1.7
...
# Array of Trinity gene mapping files
