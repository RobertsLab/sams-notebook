#!/bin/bash
## Job Name
#SBATCH --job-name=20230801-cvir-ncbi-blastx-GCF_002022765.2_C_virginica-3.0-genes
...
#SBATCH --chdir=/gscratch/scrubbed/samwhite/outputs/20230801-cvir-ncbi-blastx-GCF_002022765.2_C_virginica-3.0-genes
...
blast_db="/gscratch/srlab/blastdbs/20230727-uniprot-swissprot-reviewed/uniprot_sprot.fasta"
