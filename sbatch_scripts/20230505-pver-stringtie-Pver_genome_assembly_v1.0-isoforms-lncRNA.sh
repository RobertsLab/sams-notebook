#!/bin/bash
## Job Name
#SBATCH --job-name=20230505-pver-stringtie-Pver_genome_assembly_v1.0-isoforms-lncRNA
...
#SBATCH --chdir=/gscratch/scrubbed/samwhite/outputs/20230505-pver-stringtie-Pver_genome_assembly_v1.0-isoforms-lncRNA
...
# Paths to programs
cpc2="/gscratch/srlab/programs/CPC2_standalone-1.0.1/bin/CPC2.py"
...
prepDE="/gscratch/srlab/programs/stringtie-2.1.4.Linux_x86_64/prepDE.py"
...
merged_bam="20230505-pver-stringtie-Pver_genome_assembly_v1.0-sorted_bams-merged.bam"
lncRNAs_gtf=20230505-pver-lncRNA.gtf
