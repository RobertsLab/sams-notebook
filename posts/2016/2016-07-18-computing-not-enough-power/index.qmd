...
Well, [I tackled the storage space issue by expanding the EC2 Instance to have a 1000GB of storage space](https://robertslab.github.io/sams-notebook/posts/2016-07-17-computing-amazon-ec2-instance-out-of-space/). Now that that's no longer a concern, it turns out I'm running up against processing/memory limits!/
