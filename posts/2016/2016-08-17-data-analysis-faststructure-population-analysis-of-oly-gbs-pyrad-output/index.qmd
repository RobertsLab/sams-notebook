...
After some basal readings about what Fst is (see notebook below for a definition and reference), I decided to try to use [fastStructure](https://rajanil.github.io/fastStructure/) to analyze the PyRAD output from [20160727](https://robertslab.github.io/sams-notebook/posts/2016-07-27-data-analysis-pyrad-analysis-of-olympia-oyster-gbs-data/)./
