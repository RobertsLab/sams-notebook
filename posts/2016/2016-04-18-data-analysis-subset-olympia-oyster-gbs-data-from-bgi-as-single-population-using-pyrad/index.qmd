...
Attempting to get some sort of analysis of the _Ostrea lurida_ [GBS data from BGI](https://github.com/RobertsLab/project-olympia.oyster-genomic/wiki/Genotype-by-sequencing-November-2015), particularly since [the last run at it using Stacks](https://robertslab.github.io/sams-notebook/posts/2016-04-06-data-analysis-oly-gbs-data-from-bgi/) crashed (literally) and burned (not literally)./
