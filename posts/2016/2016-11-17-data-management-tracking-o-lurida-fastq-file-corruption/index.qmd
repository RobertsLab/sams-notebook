...
**UPDATE 20170104 - [These two corrupt files have been replaced with non-corrupt files](https://robertslab.github.io/sams-notebook/posts/2017-01-04-data-management-replacement-of-corrupt-bgi-oly-genome-fastq-files/).**/
...
[I originally downloaded the data on 20160127](https://robertslab.github.io/sams-notebook/posts/2016-01-28-data-received-ostrea-lurida-genome-sequencing-files-from-bgi/) to my home folder on Owl (this is detailed in the Jupyter notebook in that post) and generated/compared MD5 checksum values. The values matched at that time./
