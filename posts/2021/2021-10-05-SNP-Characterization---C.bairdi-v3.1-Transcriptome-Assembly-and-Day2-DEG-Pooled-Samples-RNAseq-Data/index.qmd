...
categories: 
  ...
  - Tanner Crab RNAseq
---
I previously identified variants across the four Day 2 DEG pooled RNAseq samples (380822, 380823, 380824, 380825) [on 20210909](https://robertslab.github.io/sams-notebook/posts/2021-09-09-SNP-Identification---C.bairdi-Day-2-DEG-Pooled-Samples-Using-bcftools-on-Mox/) within the `cbai_transcriptome_v3.1` transcriptome assembly. Now, I needed to actually do some analysis on the SNPs for the revisions to the [Tanner crab gene expression paper](https://github.com/RobertsLab/paper-tanner-crab) (GitHub Repo)./
