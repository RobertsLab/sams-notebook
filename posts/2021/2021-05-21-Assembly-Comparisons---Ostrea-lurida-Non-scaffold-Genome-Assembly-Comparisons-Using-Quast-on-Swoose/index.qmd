...
---
After [generating a new _Ostrea lurida_ genome assembly (v090) on 20210520](https://robertslab.github.io/sams-notebook/posts/2021/2021-05-20-Genome-Assembly-Olurida_v090-with-BGI-Illumina-and-PacBio-Hybrid-Using-Wengan-on-Mox/), I decided to compare with our previous genome assemblies. Here, I compared v090 with all of our previous scaffolded assemblies using [Quast](http://quast.sourceforge.net/quast). Here is a table (GitHub) which describes all of our existing assemblies (i.e. assembly name, assembly process, etc):/
...
The results here are interesting. The `Olurida_v090` assembly which I [generated on 20210520](https://robertslab.github.io/sams-notebook/posts/2021/2021-05-20-Genome-Assembly-Olurida_v090-with-BGI-Illumina-and-PacBio-Hybrid-Using-Wengan-on-Mox.html) Looks pretty good. However, despite having ~44M fewer bases, the `canu_sjw_01` assembly ([from 20171018](https://robertslab.github.io/sams-notebook/2017/10/18/genome-assembly-olympia-oyster-pacbio-canu-v1-6/)) could be considered "better", as it has ~4x the number of contigs >50,000bp than the `Olurida_v090`. The `canu_sjw_01` assembly also has the larger of the two assemblies' largest contigs. Also, surprisingly, the `canu_sjw_01` assembly is _only_ our PacBio sequencing data; it does _not_ include any of the Illumina short reads!/
