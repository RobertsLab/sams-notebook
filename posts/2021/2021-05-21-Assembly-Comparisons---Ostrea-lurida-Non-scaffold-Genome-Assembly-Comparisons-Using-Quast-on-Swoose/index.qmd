...
---
After [generating a new _Ostrea lurida_ genome assembly (v090) on 20210520](https://robertslab.github.io/sams-notebook/posts/2021-05-20-Genome-Assembly---Olurida_v090-with-BGI-Illumina-and-PacBio-Hybrid-Using-Wengan-on-Mox/), I decided to compare with our previous genome assemblies. Here, I compared v090 with all of our previous scaffolded assemblies using [Quast](http://quast.sourceforge.net/quast). Here is a table (GitHub) which describes all of our existing assemblies (i.e. assembly name, assembly process, etc):/
