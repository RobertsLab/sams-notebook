...
---
[After running a new _Ostrea lurida_ assembly yesterday (`Olurida_v090`)](https://robertslab.github.io/sams-notebook/posts/2021-05-20-Genome-Assembly---Olurida_v090-with-BGI-Illumina-and-PacBio-Hybrid-Using-Wengan-on-Mox/), I evaluated `Olurida_v090` using [Quast](http://quast.sourceforge.net/quast) to produce some stats. This was run on my local computer with the following command:/
