...
::: {.callout-note}
The following analysis was performed in R and is from [`Gen5-20260112-mgig-glycogen_glo-dilutions_test.Rmd`](https://github.com/RobertsLab/sormi-assay-development/blob/main/Glycogen/code/Gen5-20260112-mgig-glycogen_glo-dilutions_test.Rmd) (GitHub), commit `210087e`.
:::
...
3. Samples will need to be diluted to fall withing the standard curve.
