...
![Pacific oyster with green masking tape on the leading edge of the bottom valve to hold magnetometer, and two neodymium magnets stacked on the leading edge of the top valve. The light on the RP2040 Adalogger is illuminated, indicating it's capturing data at that moment.](./gape_monitoring_testing-01.jpg)
...
![Magnetic field magnitude over time shown for three data sets. The 3rd data set spans ~6000 seconds and highlights the periods when the shell was open in grey.](./gape_monitoring_analysis-02.jpg)
