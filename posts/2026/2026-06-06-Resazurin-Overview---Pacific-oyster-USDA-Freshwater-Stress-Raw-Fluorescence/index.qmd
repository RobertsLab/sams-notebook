...
Steven asked me to provide plot just the the raw fluorescence of resazurin data from the Pacific oyster USDA freshwater stress experiments we'd run up until now. The data is raw fluorescence, which means it has not been processed or normalized in any way.
