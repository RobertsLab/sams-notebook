...
- Spent a lot of time messing around with [Mixomics R package tutorials](https://mixomics.org/methods/). 

---

20220830

- Messed around with [Mixomics R package tutorials](https://mixomics.org/methods/) to see how we might use this for our CEABiGR analysis. Mostly just wanted to familiarize myself with how to format data to use in Mixomics package.
...
- Created notebook for [QC/trim CEABiGR larvae/zygote samples](../2022-08-29-FastQ-Trimming-and-QC---C.virginica-Larval-BS-seq-Data-from-Lotterhos-Lab-and-Part-of-CEABIGR-Project-Using-fastp-on-Mox/index.qmd).

- Updated [CEABiGR summary notebook with larval/zygote updates](../2022-04-25-Project-Summary---C.virginica-CEABIGR---Female-vs.-Male-Gonad-Exposed-to-OA/index.qmd).
...
- Chatted with Zach regarding aligning data for identification of lncRNAs. Showed him the basic HiSat2 indexing/aligning options.

- Chatted with Zach regarding mussel primers from that FISH541 class. Told him to re-run class samples with primers - most failures during class likely due to inexperience with bench work.
...
- Created notebook post for [mussel RNA isolation and reverse transcription from 20220726](../2022-07-26-RNA-Isolation-and-Quantification---Dorothy-Mussel-Gill-Samples/index.qmd)

- Created notebook post for [mussel qPCRs from 20220727](../2022-07-27-qPCR---Dorothys-Mussel-cDNA-from-20220726/index.qmd)
