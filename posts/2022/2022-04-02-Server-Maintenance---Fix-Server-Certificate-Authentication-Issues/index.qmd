...
Searching for UW intermediate server certificates led me to [this page which _actually provides the InCommon RSA Server intermediate certficates for UW_] (https://wiki.cac.washington.edu/spaces/infra/pages/66705144/InCommon+SSL+Intermediate+Certificates)! Doing a bit more research, I found the [UW page describing InCommon CA server certificates](https://wiki.cac.washington.edu/spaces/infra/pages/66705144/InCommon+SSL+Intermediate+Certificates). On that page is this crucial piece of information:
