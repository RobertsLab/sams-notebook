...
categories: 
  ...
  - Miscellaneous
---
After realizing that the [_Crassostrea virginica_ (Eastern oyster)](https://en.wikipedia.org/wiki/Eastern_oyster) RNAseq data had relatively low alignment rates (see [this notebook entry from 20220224](https://robertslab.github.io/sams-notebook/posts/2022/2022-02-24-Trimming---Additional-20bp-from-C.virginica-Gonad-RNAseq-with-fastp-on-Mox/) for a bit more background), I contacted ZymoResearch to see if they had any insight on what might be happening. I suspected rRNA contamination. ZymoResearch was kind enough to run the RNAseq data through their pipeline and provided us. This notebook entry provides a brief overview and thoughts on the report./
