...
::: {.callout-warning}
The trimmming described below is probably incomplete and should be ignored.

Updated, good trimming is available here:

- [2024-11-15-Trimming-and-QC---C.virginica-CEASMALLR-FastQs-Using-fastp-BBTools-and-FastQC-MultiQC/index.qmd](../../2024/2024-11-15-Trimming-and-QC---C.virginica-CEASMALLR-FastQs-Using-fastp-BBTools-and-FastQC-MultiQC/index.qmd) (Notebook entry)
:::
...
- epigeneticstoocean/2018OAExp_larvae (private GitHub repo)

Metadata for the files processed in this notebook:

- 2018_L18_OAExp_Cvirginica_DNAm/blob/main/data/L18_larvae_meta.csv /epigeneticstoocean/2018_L18_OAExp_Cvirginica_DNAm/blob/main/data/L18_larvae_meta.csv
