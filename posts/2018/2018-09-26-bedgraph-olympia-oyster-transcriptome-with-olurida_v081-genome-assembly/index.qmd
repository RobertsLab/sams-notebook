...
I took the sorted BAM file from [yesterday's corrected RNAseq genome alignment](https://robertslab.github.io/sams-notebook/posts/2018/2018-09-25-transcriptome-alignment-olympia-oyster-rnaseq-reads-aligned-to-genome-with-hisat2/) and converted it to a bedgraph using BEDTools genomeCoverageBed tool.
