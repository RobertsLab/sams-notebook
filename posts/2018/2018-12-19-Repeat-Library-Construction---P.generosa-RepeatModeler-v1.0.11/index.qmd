...
---
Needed to generate a generate a species-specific repeat library for use with MAKER genome annotation using [RepeatModeler](https://github.com/Dfam-consortium/RepeatModeler) and the Pgenerosa_v070.fa ([see our Genomic Resources wiki for more info](https://github.com/RobertsLab/resources/wiki/Genomic-Resources#genome-2)) version of the genome.
