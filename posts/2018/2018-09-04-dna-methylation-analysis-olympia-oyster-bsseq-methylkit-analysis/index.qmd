...
I [previously ran all of Olympia oyster DNA methylation sequencing data through the Bismark pipeline](https://robertslab.github.io/sams-notebook/posts/2018-08-16-dna-methylation-analysis-bismark-pipeline-on-all-olympia-oyster-bsseq-datasets/), and then processed them using the MethylKit R library./
