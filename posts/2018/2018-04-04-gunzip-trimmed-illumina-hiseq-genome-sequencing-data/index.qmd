...
In preparation to run SpareAssembler, I needed to gunzip the [trimmed gzipped FASTQ files from 20140401](https://robertslab.github.io/sams-notebook/posts/2018-04-01-trimgalorefastqcmultiqc-illumina-hiseq-genome-sequencing-data-continued/)./
