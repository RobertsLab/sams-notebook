...
**[Meraculous](https://1ofdmq2n8tc36m6i46scovo2e.wpengine.netdna-cdn.com/wp-content/uploads/2014/12/Manual.pdf)**:
  ...
  * Can't run locally because:
    ...
    * [Ran out of hard drive space](https://robertslab.github.io/sams-notebook/posts/2018-02-05-novaseq-assembly-trimmed-geoduck-novaseq-with-meraculous/) - due to hardware limitations of our Apple Xserve/


    * [Fixed HDD space issue, but Roadrunner locks up and has to be restarted](https://robertslab.github.io/sams-notebook/posts/2018-02-05-novaseq-assembly-trimmed-geoduck-novaseq-with-meraculous/); no error message(s) in log files to help troubleshoot/
...
**[SOAPdenovo2](https://soap.genomics.org.cn/soapdenovo.html)**
  ...
  * Our [Mox node can't handle the memory requirements](https://robertslab.github.io/sams-notebook/posts/2018-02-19-assembly-geoduck-illumina-novaseq-soapdenovo2-on-mox-fail/) needed for assembly./
