...
Yesterday, [I annotated our Olympia oyster genome using WQ-MAKER in just 7hrs!](https://robertslab.github.io/sams-notebook/posts/2018-08-07-genome-annotation-olympia-oyster-genome-using-wq-maker-instance-on-jetstream/)./
...
The results from that run can be seen here:
  ...
  * [Genome Annotation – Olympia oyster genome annotation results #01](https://robertslab.github.io/sams-notebook/posts/2018-08-08-genome-annotation-olympia-oyster-genome-annotation-results-01/)/
...
This run took about an hour longer than [the previous run](https://robertslab.github.io/sams-notebook/posts/2018-08-07-genome-annotation-olympia-oyster-genome-complete-brief-note/), but for some reason it ran with only 21 workers, instead of 22. This is probably the reason for the increased run time./
