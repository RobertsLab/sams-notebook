...
Regardless, [based on my earlier RNA isolation today](https://robertslab.github.io/sams-notebook/posts/2018-07-31-rna-isolation-tanner-crab-hemolymph-using-rneasy-plus-mini-kit/), these samples should now be much cleaner and we should be able to trust the Qubit quantifications./
