...
OK, so things have improved since [the last attempt at getting this BGI script to run](https://robertslab.github.io/sams-notebook/posts/2017-03-14-computing-oly-bgi-gbs-reproducibility-fail-but-less-so-than-last-time/) and demultiplex the raw data./
