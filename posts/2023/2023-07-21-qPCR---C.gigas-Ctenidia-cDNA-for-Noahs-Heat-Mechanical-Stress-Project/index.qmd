...
categories: 
  ...
  - Miscellaneous
---
Using [cDNA from 20230713](https://robertslab.github.io/sams-notebook/posts/2023-07-13-Reverse-Transcription---C.gigas-RNA-from-Noahs-Heat-Mechanical-Stress-Project/), performed qPCR on the following primer sets selected by Steven:/
...
`18s`: No Template Controls (NTCs) show contamination in melt curve. Since this has [shown up previously](https://robertslab.github.io/sams-notebook/posts/2023-07-19-qPCR---C.gigas-Ctenidia-cDNA-for-Noahs-Heat-Mechanical-Stress-Project/) (notebook), I suspect my primer working stocks have become contaminated. Might not redo, if `actin` is acceptable for normalization./
