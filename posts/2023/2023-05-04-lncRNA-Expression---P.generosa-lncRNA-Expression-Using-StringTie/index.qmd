...
categories: 
  ...
  - Miscellaneous
---
After [identifying lncRNA in _P.generosa_](https://robertslab.github.io/sams-notebook/posts/2023-05-02-lncRNA-Identification---P.generosa-lncRNAs-using-CPC2-and-bedtools/), [Steven asked that I generate an tissue-specific expression/count matrix](https://github.com/RobertsLab/resources/issues/1642) (GitHub Issue). Looking through the documentation for [`StringTie`](https://ccb.jhu.edu/software/stringtie/), I decided that [`StringTie`](https://ccb.jhu.edu/software/stringtie/) would work for this. The overall approach:/

- Use tissue-specifc BAMs [from HISAT2 alignments](https://robertslab.github.io/sams-notebook/posts/2023-04-26-Transcript-Alignments---P.generosa-RNA-seq-Alignments-for-lncRNA-Identification-Using-Hisat2-StingTie-and-gffcompare-on-Mox/)/

- Use ["canonical" lncRNA GTF representing all lncRNAs found across all tissues](https://robertslab.github.io/sams-notebook/posts/2023-05-02-lncRNA-Identification---P.generosa-lncRNAs-using-CPC2-and-bedtools/) as input to [`StringTie`](https://ccb.jhu.edu/software/stringtie/)./
