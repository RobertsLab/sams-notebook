...
categories: 
  ...
  - Miscellaneous
---
Addressing the update to [this GitHub Issue](https://github.com/RobertsLab/resources/issues/1434) regarding identifying [_Panopea generosa_ (Pacific geoduck)](http://en.wikipedia.org/wiki/Geoduck) long non-coding RNAs (lncRNAs), I used the RNA-seq data from [the Nextflow NF-Core RNAseq pipeline run on 20220323](https://robertslab.github.io/sams-notebook/posts/2022-03-23-Differential-Gene-Expression---P.generosa-DGE-Between-Tissues-Using-Nextlow-NF-Core-RNAseq-Pipeline-on-Mox/). Although that data was supposed to have been trimmed in the Nextflow NF-Core RNA-seq pipeline, the FastQC reports still show adapter contamination and some funky stuff happening at the 5' end of the reads. So, I've opted to trim the "trimmed" files with [`fastp`](https://github.com/OpenGene/fastp), using a hard 20bp trim at the 5' end of all reads. [`FastQC`](https://www.bioinformatics.babraham.ac.uk/projects/fastqc/) and [`MultiQC`](https://multiqc.info/) were run before/after trimming. Job was run on Mox./
...
https://robertslab.github.io/sams-notebook/posts/2022-03-23-Differential-Gene-Expression---P.generosa-DGE-Between-Tissues-Using-Nextlow-NF-Core-RNAseq-Pipeline-on-Mox//
