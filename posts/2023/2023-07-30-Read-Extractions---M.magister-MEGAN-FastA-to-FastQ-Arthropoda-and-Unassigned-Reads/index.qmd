...
categories: 
  ...
  - DuMOAR
---
After [getting `Arthropoda` and `Unassigned` reads extracted to FastA format](https://robertslab.github.io/sams-notebook/posts/2023/2023-07-26-Read-Extractions-M.magister-MEGAN-Arthropoda-and-Unassigned-Reads-to-FastA.html) (notebook entry) using [MEGAN6 Community Edition](https://software-ab.cs.uni-tuebingen.de/download/megan6/welcome/), the next step was to use the FastA files to extract reads in FastQ format. I used [`seqtk`](https://github.com/lh3/seqtk) to do this. The process is documented in the Jupyter Notebook below./
