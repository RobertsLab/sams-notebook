...
##### Plot heat stress change in fluorescence per weight
```{r heat stress-weight-adjusted}
library(tidyr)
library(dplyr)

# Step 1: Calculate the difference between A590.hs.t.1.0 and A590.hs.t.0
resazurin_df <- resazurin.df %>%
  mutate(diff = A590.hs.t.1.0 - A590.hs.t.0)
