...
toc-depth: 5
toc-location: left
title: Genome Indexing - A.pulchra Genome Using HISAT2
date: '2024-10-08'
draft: false
engine: knitr
categories: 
...
::: callout-note
This notebook entry is knitted from [`urol-e5/timeseries_molecular/D-Apul/code/02.10-D-Apul-RNAseq-genome-index-HiSat2.Rmd`](https://github.com/urol-e5/timeseries_molecular/blob/da11371ef1d0b24b991446cef9865357773c4301/D-Apul/code/02.10-D-Apul-RNAseq-genome-index-HiSat2.Rmd) (GitHub), commit `da11371`.
:::

This notebook will build an index of the *A.pulchra* genome using [HISAT2](https://github.com/DaehwanKimLab/hisat2) [@kim2019]. It utilizes the GTF file created in [`02.00-D-Apul-RNAseq-gff-to-gtf.Rmd`](https://github.com/urol-e5/timeseries_molecular/blob/main/D-Apul/code/02.00-D-Apul-RNAseq-gff-to-gtf.Rmd).
