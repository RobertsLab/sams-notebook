...
I processed the following 8 samples:
...
::: {.callout-note}
Samples `386` and `395` were initially too concentrated. The samples were diluted with an additional 50uL of H<sub>2</sub>O and measured again.
:::
...
- [`20240701-cgig-qubit-RNA.hs-carryover.csv`](https://github.com/RobertsLab/project-gigas-carryover/blob/main/lifestage_carryover/data/qubit/20240701-cgig-qubit-RNA.hs-carryover.csv) (GitHub)
