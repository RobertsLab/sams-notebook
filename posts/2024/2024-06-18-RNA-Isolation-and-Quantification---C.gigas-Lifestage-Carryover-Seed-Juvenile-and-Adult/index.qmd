...
## RNA Quantification
RNA was quantified with the Roberts Lab Qubit 3.0 fluorometer (Invitrogen). Samples were quantified with either the Qubit RNA High Sensitivity (HS) assay (Invitrogen). 1uL of sample was used for the assay(s).
