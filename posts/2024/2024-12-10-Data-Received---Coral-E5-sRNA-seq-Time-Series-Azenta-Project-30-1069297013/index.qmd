...
We received sRNA-seq data from Azenta project 30-1069297013. is in. All files were downloaded and [MD5 checksums were verified](#checksum-verification). Raw FastQ files are available here:
