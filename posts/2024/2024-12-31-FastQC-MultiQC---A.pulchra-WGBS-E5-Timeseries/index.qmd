...
The resulting [`MultiQC`](https://multiqc.info/) Report is here (HTML):

- [https://gannet.fish.washington.edu/gitrepos/urol-e5/timeseries_molecular/D-Apul/data/wgbs-raw-fastqs/multiqc_report.html](https://gannet.fish.washington.edu/gitrepos/urol-e5/timeseries_molecular/D-Apul/data/wgbs-raw-fastqs/multiqc_report.html)

::: {.callout-note}
The markdown below was knitted from [`00.20-D-Apul-WGBS-reads-FastQC-MultiQC.Rmd`](https://github.com/urol-e5/timeseries_molecular/blob/e1675941e629293b8255cc56b23c8fedc7024b80/D-Apul/code/00.20-D-Apul-WGBS-reads-FastQC-MultiQC.Rmd) (commit `e167594`).
:::
