...
categories: 
  ...
  - Azenta
---
We'd [previously received RNA-seq data from Azenta on 2024-02-21](../2024-02-21-Data-Received---Pacific-cod-RNA-seq-Azenta-Project-30-943133806/index.qmd). However, Laura realized that there was a large discrepancy between the amount of reads returned between samples. Additionally, the quote for this project indicated a minimum of 20M reads/sample and many were below that threshold. I contacted Azenta and, after having to ping them a _lot_, they finally re-sequenced the samples.
