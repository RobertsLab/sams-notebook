...
![Gel](./20240531-gmac-gel-gDNA-labeled.jpg){#fig-gel fig-alt="Gel with untouched samples on left." .lightbox}

![Ladder](./ogene-ruler.jpeg){#fig-ladder fig-alt="O'GeneRuler" .lightbox}

The untouched samples look as one would expect - nice sharp, high-molecular weight band with minimal smearing. This is indicative of high quality, intact gDNA. However, the previously touched samples show signs of heavy degradation, as evidenced by a lack of defined, high-molecular weight band, as well as extensive smearing.