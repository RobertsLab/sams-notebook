...
categories:
  ...
  - Miscellaneous
---
Yesterday, we [received the last of the RNAseq data for the _C.bairdi_ crab project from NWGSC](https://robertslab.github.io/sams-notebook/posts/2020-04-13-Data-Received---C.bairdi-RNAseq-from-NWGSC/). FastQC, followed by MultiQC was run on the raw FastQ reads on my computer (swoose)./
