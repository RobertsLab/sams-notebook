...
categories:
  ...
  - Miscellaneous
---
This is a continuation of addressing [Shelly Trigg's (regarding some _Salmo salar_ RNAseq data) request (GitHub Issue)](https://github.com/RobertsLab/resources/issues/1016) to trim ([completed 20201029](https://robertslab.github.io/sams-notebook/posts/2020/2020-10-29-Trimming-Shelly-S.salar-RNAseq-Using-fastp-and-MultiQC-on-Mox.html)), perform genome alignment ([completed on 20201103](https://robertslab.github.io/sams-notebook/2020/11/03/RNAseq-Alignments-Trimmed-S.salar-RNAseq-to-GCF_000233375.1_ICSASG_v2_genomic.fa-Using-Hisat2-on-Mox/)), and transcriptome alignment./

To finish this up, I used [`StringTie`](https://ccb.jhu.edu/software/stringtie/) to align to a subset of the `GCF_000233375.1_ICSASG_v2_genomic.gtf` provided by Shelly. I created a subset (see SBATCH script below for deets) that only included the same sequence IDs in Shelly's subsetted genome Fasta (see genome alignment [completed on 20201103](https://robertslab.github.io/sams-notebook/posts/2020/2020-11-03-RNAseq-Alignments-Trimmed-S.salar-RNAseq-to-GCF_000233375.1_ICSASG_v2_genomic.fa-Using-Hisat2-on-Mox/) for more info on that.)./
