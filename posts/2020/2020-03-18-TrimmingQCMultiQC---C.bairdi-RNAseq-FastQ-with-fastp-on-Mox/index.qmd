...
categories:
  ...
  - Tanner Crab RNAseq
---
After [receiving our RNAseq data from Genewiz earlier today](https://robertslab.github.io/sams-notebook/posts/2020-03-18-Data-Received---C.bairdi-RNAseq-Data-from-Genewiz/), needed to run FastQC, trim, check trimmed reads with FastQC./
