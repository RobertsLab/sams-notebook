...
categories:
  ...
  - Miscellaneous
---
This is a continuation of addressing [Shelly Trigg's (regarding some _Salmo salar_ RNAseq data) request (GitHub Issue)](https://github.com/RobertsLab/resources/issues/1016) to trim ([completed 20201029](https://robertslab.github.io/sams-notebook/posts/2020-10-29-Trimming---Shelly-S.salar-RNAseq-Using-fastp-and-MultiQC-on-Mox/)), perform genome alignment, and transcriptome alignment./

Ran [`HISAT2`](https://daehwankimlab.github.io/hisat2/) with the [trimmed FastQ files from 20201029](https://robertslab.github.io/sams-notebook/posts/2020-10-29-Trimming---Shelly-S.salar-RNAseq-Using-fastp-and-MultiQC-on-Mox/) with the following options:/
