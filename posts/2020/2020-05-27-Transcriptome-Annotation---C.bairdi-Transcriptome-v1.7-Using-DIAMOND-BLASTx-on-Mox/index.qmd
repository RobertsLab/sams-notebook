...
categories:
  ...
  - Miscellaneous
---
As part of annotating [cbai_transcriptome_v1.7.fasta from 20200527](https://robertslab.github.io/sams-notebook/posts/2020-05-27-Transcriptome-Assembly---C.bairdi-All-Pooled-Arthropoda-only-RNAseq-Data-with-Trinity-on-Mox/), I need to run DIAMOND BLASTx to use with Trinotate./
