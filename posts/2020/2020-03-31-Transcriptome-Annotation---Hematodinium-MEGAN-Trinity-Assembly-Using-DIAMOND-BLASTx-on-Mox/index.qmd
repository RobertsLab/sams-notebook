...
categories:
  ...
  - Miscellaneous
---
As part of annotating the most recent [transcriptome assembly from the MEGAN6 _Hematodinium_ taxonomic-specific reads](https://robertslab.github.io/sams-notebook/posts/2020/2020-03-31-Transcriptome-Assembly---Hematodinium-with-MEGAN6-Taxonomy-specific-Reads-with-Trinity-on-Mox/), I need to run DIAMOND BLASTx to use with Trinotate./
