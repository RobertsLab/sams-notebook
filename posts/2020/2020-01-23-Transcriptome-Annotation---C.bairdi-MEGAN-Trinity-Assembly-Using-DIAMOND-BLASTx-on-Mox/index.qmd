...
categories:
  ...
  - Tanner Crab RNAseq
---
As part of annotating the [transcriptome assembly from the MEGAN6 _C.bairdi_ taxonomic-specific reads](https://robertslab.github.io/sams-notebook/posts/2020-01-22-Transcriptome-Assembly---C.bairdi-with-MEGAN6-Taxonomy-specific-Reads-with-Trinity-on-Mox/), I need to run DIAMOND BLASTx to use with Trinotate./
