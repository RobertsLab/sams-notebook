...
categories:
  ...
  - Miscellaneous
---
As part of annotating the _C.bairdi_ [v2.0 transcriptome assembly from 20200502](https://robertslab.github.io/sams-notebook/posts/2020/2020-05-02-Transcriptome-Assembly---C.bairdi-All-RNAseq-Data-Without-Taxonomic-Filters-with-Trinity-on-Mox/), I need to run DIAMOND BLASTx to use with Trinotate./
