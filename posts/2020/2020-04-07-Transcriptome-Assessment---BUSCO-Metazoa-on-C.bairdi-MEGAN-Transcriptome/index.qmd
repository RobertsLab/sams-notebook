...
categories:
  ...
  - Miscellaneous
---
[I previously created a _C.bairdi_ _de novo_ transcriptome assembly with Trinity from the MEGAN6 taxonomic-specific reads for _Arthropoda_ on 20200330](https://robertslab.github.io/sams-notebook/posts/2020-03-30-Transcriptome-Assembly---C.bairdi-with-MEGAN6-Taxonomy-specific-Reads-with-Trinity-on-Mox/) and decided to assess its "completeness" using BUSCO and the `metazoa_odb9` database./
