...
categories:
  ...
  - Miscellaneous
---
Time to start working with [the NanoPore data that I generated back in _January_(???!!!)](https://robertslab.github.io/sams-notebook/posts/2020-01-09-NanoPore-Sequencing---C.bairdi-gDNA-Sample-20102558-2729/). In order to proceed, I first need to convert the raw Fast5 files to FastQ. To do so, I'll use the NanoPore program `guppy`./
