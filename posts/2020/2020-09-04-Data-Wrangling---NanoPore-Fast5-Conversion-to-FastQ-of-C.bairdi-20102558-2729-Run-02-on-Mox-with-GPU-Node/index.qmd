...
categories:
  ...
  - Miscellaneous
---
Continuing to work with [the NanoPore data that I generated back in _January_(???!!!)](https://robertslab.github.io/sams-notebook/posts/2020/2020-01-09-NanoPore-Sequencing-C.bairdi-gDNA-Sample-20102558-2729.html). In order to proceed, I first need to convert the raw Fast5 files to FastQ. To do so, I'll use the NanoPore program `guppy`. I converted the [first run from this flowcell earlier today](https://robertslab.github.io/sams-notebook/2020/09/04/Data-Wrangling-NanoPore-Fast5-Conversion-to-FastQ-of-C.bairdi-20102558-2729-Run-01-on-Mox-with-GPU-Node/)./
