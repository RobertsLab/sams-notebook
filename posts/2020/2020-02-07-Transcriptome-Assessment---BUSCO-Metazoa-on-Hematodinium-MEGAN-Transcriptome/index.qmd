...
categories:
  ...
  - Tanner Crab RNAseq
---
[I previously created a _Hematodinium_ _de novo_ transcriptome assembly with Trinity from the MEGAN6 taxonomic-specific reads for _Alveolata_ on 20200122](https://robertslab.github.io/sams-notebook/posts/2020-01-22-Transcriptome-Assembly---Hematodinium-with-MEGAN6-Taxonomy-specific-Reads-with-Trinity-on-Mox/) and decided to assess its "completeness" using BUSCO and the `metazoa_odb9` database./
