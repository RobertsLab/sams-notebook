...
categories:
  ...
  - Miscellaneous
---
[I previously created a _C.bairdi_ _de novo_ transcriptome assembly with Trinity from all our _C.bairdi_ pooled RNAseq (not taxonomically filtered) on 20200518](https://robertslab.github.io/sams-notebook/posts/2020-05-18-Transcriptome-Assembly---C.bairdi-All-Pooled-RNAseq-Data-Without-Taxonomic-Filters-with-Trinity-on-Mox/) and decided to assess its "completeness" using BUSCO and the `metazoa_odb9` database./
