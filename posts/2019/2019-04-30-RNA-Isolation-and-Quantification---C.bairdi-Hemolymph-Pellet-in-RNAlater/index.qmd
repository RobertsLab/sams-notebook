...
categories:
  ...
  - Miscellaneous
---
After the [success we had isolating RNA using the Quick-DNA/RNA Microprep Plus Kit (ZymoResearch)](https://robertslab.github.io/sams-notebook/posts/2019-04-11-RNA-Isolation-and-Quantification---Crab-Hemolypmh-Using-Quick-DNA-RNA-Microprep-Plus-Kit/), Steven had me isolate RNA from a list of ~117 samples. Of that list, I was able to find 66 crab hemolymph pelleted RNAlater samples. The "missing" samples were most likely previosly used by Grace during our various attempts to get some usable RNA out these./
