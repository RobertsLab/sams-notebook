...
---
Since the [MAKER genome annotation of our Pgenerosa_v070 genome assembly](https://robertslab.github.io/sams-notebook/posts/2019-02-28-Genome-Annotation---Pgenerosa_v070-MAKER-on-Mox/) finally completed last week, I decided to separate out the various features into separate GFF files, as I'm sure we'll need/want them at some point. This was all done in a Jupyter Notebook on my computer (swoose) - see notebook linked below./
