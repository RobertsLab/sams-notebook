...
---
[After getting through the initial MAKER annotation and SNAP gene predictions](https://robertslab.github.io/sams-notebook/posts/2018/2018-11-27-Annotation-Olurida_v081-MAKER-on-Mox/), and then [renaming the sequences](https://robertslab.github.io/sams-notebook/2019/01/08/Annotation-Olurida_v081-MAKER-ID-Mapping/), I needed to run BLASTp on the FastA file produced by MAKER id mapping in order to assign functionality to the predicted genes.
