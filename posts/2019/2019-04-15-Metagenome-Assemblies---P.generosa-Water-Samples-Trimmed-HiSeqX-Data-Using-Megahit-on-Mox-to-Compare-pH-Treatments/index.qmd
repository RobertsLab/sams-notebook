...
I ran [MEGAHIT](https://github.com/voutcn/megahit) on the [trimmed HiSeqX data](https://robertslab.github.io/sams-notebook/posts/2018/2018-12-11-FastQC-and-Trimming---Metagenomics-Geoduck-HiSeqX-Reads-from-20180809/), but concatenated the corresponding pH treatment FastQ files to create a single assembly for each pH treatment.
