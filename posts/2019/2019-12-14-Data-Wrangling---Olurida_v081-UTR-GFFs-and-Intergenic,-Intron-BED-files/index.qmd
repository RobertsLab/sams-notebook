...
As part of that, we needed a new intron GFF file generated. I also realized that the output from the [MAKER annotation from 20190709](https://robertslab.github.io/sams-notebook/posts/2019-07-09-Genome-Annotation---Olurida_v081-with-MAKER-and-Tissue-specific-Transcriptomes-on-Mox/) actually has 3'/5' UTR features, so I decided to separate those out and create separate GFFs for them, as well./
