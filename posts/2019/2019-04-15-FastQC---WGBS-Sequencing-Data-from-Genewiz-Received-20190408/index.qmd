...
We received whole genome bisulfite sequencing (WGBS) data from Genewiz [last week on 20190408](https://robertslab.github.io/sams-notebook/posts/2019-04-08-Data-Management---Whole-Genome-Bisulfite-Sequencing-Data-from-Genewiz-Received/), so ran FastQC on the files on my computer (swoose). FastQC results will be added to [Nightingales Google Sheet](http://b.link/nightingales)./
