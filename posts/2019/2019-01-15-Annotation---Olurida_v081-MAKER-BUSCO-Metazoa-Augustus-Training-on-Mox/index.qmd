...
---
[Previously performed this analysis using the ```eukaryota_odb9``` BUSCO database](https://robertslab.github.io/sams-notebook/posts/2019-01-14-Annotation---Olurida_v081-MAKER-BUSCO-Augustus-Training/). Figured I'd give it another go using a more specific database, ```metazoa_odb9```, for comparison./
