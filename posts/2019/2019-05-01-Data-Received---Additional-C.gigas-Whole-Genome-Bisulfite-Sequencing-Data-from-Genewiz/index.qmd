...
categories:
  ...
  - Miscellaneous
---
The [FastQC analysis](https://robertslab.github.io/sams-notebook/posts/2019/2019-04-15-FastQC-WGBS-Sequencing-Data-from-Genewiz-Received-20190408/) of the intitial data we received from Genewiz ([on 20190408](https://robertslab.github.io/sams-notebook/2019/04/08/Data-Management-Whole-Genome-Bisulfite-Sequencing-Data-from-Genewiz-Received/))showed consistent failures in the "Per Tile Sequence Quality" for all of Roberto's _Crassostrea gigas_ sequencing. After discussing with Genewiz, they offered to generate an additional 25% reads for each of those libraries./
