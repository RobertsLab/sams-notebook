...
::: {.callout-note}
The contents below are from markdown knitted from [`00.21-D-Apul-BS-genome.Rmd`](https://github.com/urol-e5/timeseries_molecular/blob/0fbd6aed0eed0e35926cab13256bbb5c70445de8/D-Apul/code/00.21-D-Apul-BS-genome.Rmd) (commit `0fbd6ae`).
:::
