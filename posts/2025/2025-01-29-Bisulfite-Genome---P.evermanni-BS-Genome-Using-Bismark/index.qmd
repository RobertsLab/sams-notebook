...
toc-depth: 5
toc-location: left
title: Bisulfite Genome - P.evermanni BS Genome Using Bismark
date: '2025-01-29'
draft: false
engine: knitr
categories: 
...
In preparation for [`Bismark`](https://github.com/FelixKrueger/Bismark) alignments, we needed to generate a bisulfite-converted genome for _P.evermanni_, as one did not already exist.

The resulting output files were added to the [Genomic Resources Handbook page](https://robertslab.github.io/resources/Genomic-Resources/) and the [timeseries_molecular repo Wiki](https://github.com/urol-e5/timeseries_molecular/wiki/00%E2%80%90Genomic%E2%80%90Resources#bisulfite-genome-1).

::: {.callout-note}
The contents below are from markdown knitted from [`00.21-E-Peve-BS-genome.Rmd`](https://github.com/urol-e5/timeseries_molecular/blob/5b56975e21432f63342965b4abe87a235ec8ee62/E-Peve/code/00.21-E-Peve-BS-genome.Rmd) (commit `5b56975`).
:::
...
file. The genome FastA was taken from the [Genoscope corals
