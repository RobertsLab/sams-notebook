...
toc-depth: 5
toc-location: left
title: Data Exploration - E5 Timeseries Multi-species Multi-omics Using Barnacle
date: '2025-10-08'
draft: false
engine: knitr
categories: 
...
[Barnacle](https://github.com/blasks/barnacle) (GitHub Repo) utilizes tensor decomposition. As such, the analysis is constrained, due to the fact that the tensors must have the same dimensions as each other. [MOFA2](https://biofam.github.io/MOFA2/index.html) is not limited by data dimensionality. So, for this barnacle analysis, we're only using gene expression as a metric, with the goal being to identify genes/components (factors) which might be associated with components associated with some characterized physiology. Then, we can potentially look at lncRNA/miRNA/methylation in those contexts.
...
[https://github.com/urol-e5/timeseries_molecular/blob/d88c40082bb7d2902eb847dd2fcad7476cae2928/M-multi-species/scripts/13.00-multiomics-barnacle.Rmd](https://github.com/urol-e5/timeseries_molecular/blob/d88c40082bb7d2902eb847dd2fcad7476cae2928/M-multi-species/scripts/13.00-multiomics-barnacle.Rmd) (commit `d88c400`)
:::


::: {.callout-note}
The contents below are from knitted markdown [`13.00-multiomics-barnacle.Rmd`](https://github.com/urol-e5/timeseries_molecular/blob/5e572b67dd86c49154d1627993ac01be81b4b368/M-multi-species/scripts/13.00-multiomics-barnacle.md) (commit `5e572b6`).
:::
