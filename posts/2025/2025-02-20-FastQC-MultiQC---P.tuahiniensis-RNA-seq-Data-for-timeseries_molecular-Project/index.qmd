...
toc-depth: 5
toc-location: left
title: FastQC MultiQC - P.tuahiniensis RNA-seq Data for timeseries_molecular Project
date: '2025-02-20'
draft: false
engine: knitr
categories: 
...
This notebook ran [`FastQC`](https://www.bioinformatics.babraham.ac.uk/projects/fastqc/) and [`MultiQC`](https://multiqc.info/) on the _P.evermanni_ raw RNA-seq data [received 20240926](../../2024/2024-09-26-Data-Received---E5-Coral-Time-Series-RNA-seq-Azenta-Project-30-1047560508/index.qmd) (Notebook), as part of [urol-e5/timeseries_molecular](https://github.com/urol-e5/timeseries_molecular) (GitHub repo).

Additionally, it renamed the raw FastQs as `<species>-<colony_ID>-<timepoint>` to allow for easier sample parsing and maintain consistency throughout the project.

::: {.callout-note}
The contents below are from markdown knitted from [`00.00-F-Ptua-RNAseq-reads-FastQC-MultiQC.md`](https://github.com/urol-e5/timeseries_molecular/blob/7d2ba1c4e98a5f1a371e3d0389330099f2951271/F-Ptua/code/00.00-F-Ptua-RNAseq-reads-FastQC-MultiQC.md) (commit `7d2ba1c`).
:::
...
- [F-Ptua/data/rnaseq-raw-fastqs/multiqc_report.html](https://github.com/urol-e5/timeseries_molecular/blob/7d2ba1c4e98a5f1a371e3d0389330099f2951271/F-Ptua/data/rnaseq-raw-fastqs/multiqc_report.html) (GitHub repo)

![MultiQC screencap showing Sequence Content.](./20250220-ptua-rnaseq-multiqc-plot-sequence-content.png){fig-alt="Screenshot of trimmed MultiQC per base sequence content plot showing"}


![MultiQC screencap showing Adapter Content.](./20250220-ptua-rnaseq-multiqc-plot-adapter-content.png){fig-alt="Screenshot of MultiQC Adapter Content."}
