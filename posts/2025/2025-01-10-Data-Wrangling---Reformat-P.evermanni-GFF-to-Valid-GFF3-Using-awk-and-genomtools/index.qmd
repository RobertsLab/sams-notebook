...
::: {.callout-note}
The contents below are from markdown knitted from [`00.00-genome-GFF-formatting.Rmd`](https://github.com/urol-e5/timeseries_molecular/blob/9d289abac23c46786a66a3496f4bab41362c3f2b/E-Peve/code/00.00-genome-GFF-formatting.Rmd) (commit `9d289ab`).
:::
