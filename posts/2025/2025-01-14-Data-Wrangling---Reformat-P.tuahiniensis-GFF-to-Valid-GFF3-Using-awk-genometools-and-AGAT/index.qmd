...
toc-depth: 5
toc-location: left
title: Data Wrangling - Reformat P.tuahiniensis GFF to Valid GFF3 Using awk genometools and AGAT
date: '2025-01-14'
draft: false
engine: knitr
categories:
...
::: {.callout-note}
The contents below are from markdown knitted from [`00.00-genome-GFF-formatting.Rmd`](https://github.com/urol-e5/timeseries_molecular/blob/e4361d794b8a6887bc80a979491cb931e93f3e2a/F-Ptua/code/00.00-genome-GFF-formatting.Rmd) (commit `e4361d7`).
:::
