...
toc-depth: 5
toc-location: left
title: FastQC MultiQC - P.evermanni RNA-seq Data for timeseries_molecular Project
date: '2025-02-20'
draft: false
engine: knitr
categories: 
...
::: {.callout-note}
The contents below are from markdown knitted from [`00.00-E-Peve-RNAseq-reads-FastQC-MultiQC.md`](https://github.com/urol-e5/timeseries_molecular/blob/69ad137f399c028cb7ba1312e513860b0e961800/E-Peve/code/00.00-E-Peve-RNAseq-reads-FastQC-MultiQC.md) (commit `69ad137`).
:::
...
- [E-Peve/data/rnaseq-raw-fastqs/multiqc_report.html](https://github.com/urol-e5/timeseries_molecular/blob/69ad137f399c028cb7ba1312e513860b0e961800/E-Peve/data/rnaseq-raw-fastqs/multiqc_report.html) (GitHub repo)

![MultiQC screencap showing Sequence Content.](./20250220-peve-rnaseq-multiqc-plot-sequence-content.png){fig-alt="Screenshot of trimmed MultiQC per base sequence content plot showing"}


![MultiQC screencap showing Adapter Content.](./20250220-peve-rnaseq-multiqc-plot-adapter-content.png){fig-alt="Screenshot of MultiQC Adapter Content."}
