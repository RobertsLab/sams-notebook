...
In preparation for RNA-seq analysis for [urol-e5/timeseries_molecular](https://github.com/urol-e5/timeseries_molecular) (GitHub repo) project, I previously indexed the genome using [`HISAT2`](https://daehwankimlab.github.io/hisat2/) [earlier today](../2025-03-07-Genome-Indexing---P.tuahiniensis-Using-Hisat2-on-Raven/index.qmd).
...
::: {.callout-note}
The contents below are from markdown knitted from [`02.20-F-Ptua-RNAseq-alignment-HiSat2.Rmd`](https://github.com/urol-e5/timeseries_molecular/blob/ac67faa70c79c381423aecbd23f9a2f9205a4be5/F-Ptua/code/02.20-F-Ptua-RNAseq-alignment-HiSat2.Rmd) (commit `ac67faa7`).
:::
