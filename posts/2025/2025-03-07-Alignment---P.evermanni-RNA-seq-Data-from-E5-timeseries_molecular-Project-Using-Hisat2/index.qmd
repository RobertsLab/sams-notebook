...
::: {.callout-note}
The contents below are from markdown knitted from [`02.20-E-Peve-RNAseq-alignment-HiSat2.Rmd`](https://github.com/urol-e5/timeseries_molecular/blob/3963266a6d2db1b2dd4c9f424fdd85c5ff1a3f1b/E-Peve/code/02.20-E-Peve-RNAseq-alignment-HiSat2.Rmd) (commit `3963266`).
:::
