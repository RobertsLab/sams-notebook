...
[After determining the minimum number of PCR cycles to run to generate a visible, 166bp band on a gel yesterday](https://robertslab.github.io/sams-notebook/posts/2015-10-12-pcr-oly-rad-seq-test-scale-pcr-3/), ran a full library "prep scale" PCR./
...
Well, this is lame. There are absolutely no PCR products on this gel. In fact, this just looks like big smears of degraded DNA. I was expecting an amplicon of ~166bp to cut out of the gel. [Based off of the test scale PCR from yesterday](https://robertslab.github.io/sams-notebook/posts/2015-10-12-pcr-oly-rad-seq-test-scale-pcr-3/), everything should have been hunky dory. Not really sure what to think about this.../
