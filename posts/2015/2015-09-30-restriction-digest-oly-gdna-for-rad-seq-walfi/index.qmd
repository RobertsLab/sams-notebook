...
Used a subset (10 samples) from [the _Ostrea lurida_ gDNA isolated 20150916](../2015-09-17-dna-isolation-olympia-oyster-whole-body/index.qmd) to prepare RAD libraries. This will be done to assess whether or not these samples, [which appear to be heavily degraded](../2015-09-18-agarose-gel-geoduck-olympia-oyster-gdna-integrity-check-4/index.qmd), are viable for RAD-seq.
