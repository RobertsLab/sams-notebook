...
The [gDNA I extracted on 20151104](https://robertslab.github.io/sams-notebook/posts/2015-11-05-dna-quantification-quality-assessment-geoduck-oly-gdna/) didn't look great on the NanoDrop so I decided to perform a phenol-chloroform cleanup to see if I could improve the NanoDrop1000 absorbance spectrum and, in turn, the quality of the gDNA./
...
Regardless, this is a solid yield (using yield from Quant-IT) and, when combined with [the other _Ostrea lurida_ gDNA that I isolated today](https://robertslab.github.io/sams-notebook/posts/2015-11-25-dna-isolation-olympia-oyster-outer-mantle-gdna/), should push the total amount of gDNA submitted to BGI over the required threshold./
