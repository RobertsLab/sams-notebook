...
[The gel I ran earlier today](https://robertslab.github.io/sams-notebook/posts/2015-12-17-agarose-gel-oly-gdna-for-bs-seq-libraries/) looked real rough, due to the fact that I didn't bother to equalize loading quantities of samples (I just loaded 1μL of all samples regardless of concentration). So, I'm repeating it using 100ng of DNA from all samples./

Additionally, this gel also [includes _C.gigas_ samples that Katie Lotterhos sent to us](https://robertslab.github.io/sams-notebook/posts/2015-12-10-samples-received-c-gigas-tissue-dna-from-katie-lotterhos/) to see how they look./
