...
Re-quantified [the libraries that were completed yesterday](https://robertslab.github.io/sams-notebook/posts/2015/2015-12-21-illumina-methylation-library-construction-olyc-gigas-bisulfite-treated-dna/) using the Qubit3.0 dsDNA HS (high sensitivity) assay because the library concentrations were too low for the normal broad range kit./
