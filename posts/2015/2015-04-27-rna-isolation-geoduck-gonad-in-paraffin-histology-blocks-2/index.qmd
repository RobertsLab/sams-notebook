...
UPDATE 20150528: The RNA isolated in this notebook entry may have been consolidated on [20150528](https://robertslab.github.io/sams-notebook/posts/2015-05-28-bioanalyzer-geoduck-gonad-rna-quality-assessment/)./

[Last week's RNA isolation](https://robertslab.github.io/sams-notebook/posts/2015-04-24-rna-isolation-geoduck-gonad-in-paraffin-histology-blocks/) failed for more than half of the samples I processed. I will re-isolate RNA from the following samples:/
...
IMPORTANT:
  ...
  * I used [aliquots of DNase prepared on 20150408](https://robertslab.github.io/sams-notebook/posts/2015-04-09-rna-isolation-geoduck-foot-in-paraffin-histology-blocks/)./
...
Well, these results are very consistent with the [data from the last isolation](https://robertslab.github.io/sams-notebook/posts/2015-04-24-rna-isolation-geoduck-gonad-in-paraffin-histology-blocks/) performed on these samples. This fact suggests that the problem lies with the tissue samples and not the isolation (since the isolation has been performed two separate times on these same samples and the results have come out virtually identical both times)./
